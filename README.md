...
```
near call $ID nft_mint '{"token_id": "0", "receiver_id": "'$ID'", "token_metadata": { "title": "Some Art", "description": "My NFT media", "media": "https://bafybeihmf6dfytsisgoir7324vrtwtcbct4tjd6oh5ofo6yx2wh2l6uliq.ipfs.dweb.link/", "copies": 1}}' --accountId $ID --deposit 0.1
```

```
near call nft.examples.testnet nft_mint '{"token_id": "LUDIUM_NFT_TEST", "receiver_id": "'$NEARID'", "metadata": { "title": "GO TEAM", "description": "The Team Goes", "media": "https://bafybeidl4hjbpdr6u6xvlrizwxbrfcyqurzvcnn5xoilmcqbxfbdwrmp5m.ipfs.dweb.link/", "copies": 1}}' --accountId $NEARID --deposit 0.1
```
